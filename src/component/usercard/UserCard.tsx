...
// export default function UserCard({firstname, lastName: lastname, role, username, eMail, age, onDelete, sessionUserRole,}: UserCardProps) {

export default function UserCard({firstname, lastname, role, username, eMail, age,}: UserCardProps) {
